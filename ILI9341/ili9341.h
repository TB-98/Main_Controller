...
#define LCD_CmdWrite(command)	*(__IO uint16_t *)(0x60000000) = command
#define LCD_DataWrite(data)		*(__IO uint16_t *)(0x60080000) = data
#define	LCD_StatusRead()		*(volatile uint16_t *) (0x60000000) //if use read  Mcu interface DB0~DB15 needs increase pull high
#define	LCD_DataRead()			*(volatile uint16_t *) (0x60080000) //if use read  Mcu interface DB0~DB15 needs increase pull high

//#define LCD_BASE0        		((uint32_t)0x60000000)
//#define LCD_BASE1        		((uint32_t)0x60040000)
//
